    ...
    <form id="formSubmit" class="form-wrapper" action="/" method="post"><input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        ...
        <table width="100%" border="0" align="left" cellpadding="5" cellspacing="0" class="box" style="color: #000000">
            ...
            <tr align="center">
                <td colspan="9"><p align="center" class="auto-style5">
                    <?php 	echo '<center><form action="/" method="POST"><input name="download" type="hidden" value="'.base64_encode(serialize($sarray)).'" size="30"><input class="button" type="submit" value="Export Data"></form></center>'; ?></td>
            </tr>
        </table>
        <?php
        }
